    ...
    <>
      <div className="drawer">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu text-base-content min-h-full w-60 p-4 bg-black">

            <div className="flex items-center">
              <button className="btn border-0 shadow-none bg-black text-xl font-bold cursor-pointer w-10 mr-2">
                ✕
              </button>
              <Link
                to="/home"
