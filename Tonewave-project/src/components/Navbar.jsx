...
const Navbar = () => {
  return (
    <div className="navbar flex justify-between bg-black shadow-sm px-10">
        <Link to="/home" className="btn bg-black border-0 normal-case text-xl">
          <svg
        ...
        <input
          type="text"
          placeholder="Search"
          className="input input-bordered rounded-2xl w-sm"
        />
        </div>
